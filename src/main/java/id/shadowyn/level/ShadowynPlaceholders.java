...
public final class ShadowynPlaceholders extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        return switch (lower) {
            ...
            case "archery", "archery_point" -> String.valueOf(profile.stat(StatType.ARCHERY));
            case "fight", "fighting", "fighting_point" -> String.valueOf(profile.stat(StatType.FIGHTING));
            case "power" -> String.valueOf(profile.stat(StatType.POWER));
            case "attack" -> String.valueOf(profile.stat(StatType.POWER));
            case "health", "health_point" -> String.valueOf(profile.stat(StatType.HEALTH));
            case "resistance" -> String.valueOf(profile.stat(StatType.DEFENSE));
            case "defense", "defense_point" -> String.valueOf(profile.stat(StatType.DEFENSE));
            ...
            case "alchemy", "alchemy_point" -> String.valueOf(profile.stat(StatType.ALCHEMY));
